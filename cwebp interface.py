...
for root, dirs, files in os.walk(input_path):
    ...
    for file in files:
        ...
        if file.endswith('.png') or file.endswith('.jpg') or file.endswith('q80.webp'):
            ...
            try:
                ...
                run(["cwebp", "-q", "60", "-short", os.path.join(root, file).encode(), "-o", os.path.join(root, name + " q80.webp").encode()],universal_newlines=True,encoding="utf8")
